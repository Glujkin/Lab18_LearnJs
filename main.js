...
console.log("a3 === b3:", a3 === b3);  
console.log("Вывод: приводит типы, сравнивает строго");


let age2 = 18;
let status = age2 >= 18 ? "Совершеннолетний" : "Несовершеннолетний";
console.log("\nТернарный оператор:", status);
...
switch (monthNumber) {
    ...
    default: monthName = "Неверный номер месяца";
}

console.log(`\nМесяц №${monthNumber} — это ${monthName}`);